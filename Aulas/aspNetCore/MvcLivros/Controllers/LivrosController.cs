...
namespace MvcLivros.Controllers
{
    public class LivrosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Titulo,DataLancamento,Genere,Preco")] Livro livro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Titulo,DataLancamento,Genere,Preco")] Livro livro)
        {
            if (id != livro.Id)
            {
                return NotFound();
