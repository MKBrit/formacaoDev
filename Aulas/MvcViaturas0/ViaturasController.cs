...
namespace MvcViaturas0
{
    public class ViaturasController : Controller
    {
        private readonly MvcViaturas0Context _context;

        public ViaturasController(MvcViaturas0Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Viatura != null ? 
                          ...
                          Problem("Entity set 'MvcViaturas0Context.Viatura'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MvcViaturas0Context.Viatura'  is null.");
            }
            var viatura = await _context.Viatura.FindAsync(id);
            if (viatura != null)
            {
